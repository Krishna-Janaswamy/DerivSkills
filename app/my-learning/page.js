    ...
    return (
      <main className="page-shell" style={{ maxWidth: '800px', margin: '4rem auto', paddingBottom: '4rem' }}>
        <div style={{ padding: '4rem 2rem', textAlign: 'center', background: 'var(--surface-color)', borderRadius: '24px', border: '1px solid var(--border-color)', boxShadow: '0 25px 50px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.08)' }}>
          ...
          <h2 className="page-title" style={{ marginBottom: '1rem', fontSize: '2.5rem' }}>Sign in Required</h2>
          <p className="page-subtitle" style={{ marginBottom: '2rem', lineHeight: 1.6, fontSize: '1.1rem' }}>
            To track progress, use timers, and get advanced progression analytics permanently stored in your cloud profile, you must be logged in.
          </p>
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
            <Link href="/profile" className="role-link" style={{ textDecoration: 'none', padding: '1rem 3rem', fontSize: '1.1rem', borderRadius: '999px' }}>
              Sign In Securely
            </Link>
          </div>
        </div>
